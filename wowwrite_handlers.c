...
* @ind: Index in which a number starts at the buffer
* @buffer: Buffer
* @flags: Flags
* @width: width
...
* @ind: Index in which the number starts at the buffer
* @length: Length of the number
* @width: Width specifier
* @flags: Flag specifier
* @padd: Char representing a padding
* @extra_c: Char representing an extra char
* @padd_start: Index in which the padding should start
*
* Return: Number of written chars.
*/
